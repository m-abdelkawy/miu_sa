Lab status: finished as required

had a lot of issues with versions of eureka with spring

in one project in the yml file, I have included some stackoverflow link for an error I have been stuck with with some time
